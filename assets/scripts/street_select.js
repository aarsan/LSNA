                ...
                $('#data_box').append('</br><form action="/properties/add" method="post"><input type="text" name="number"><input type="hidden" name="street" value=" '+full_name+' "><input type="text" name="zip"><input type="submit" name="enter" value="Enter Property"></form>');
